package datazeus.learnsql.series3._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 3 · 20
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * EXPLAIN / EXPLAIN ANALYZE — Reading the Plan to Find Out Why a Query Is Slow
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series3/_20/ when it is real.
 *
 *     zeus.bat koans learnsql series3 _20     (Windows)
 *     ./zeus.sh koans learnsql series3 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
