package datazeus.learnsql.series3._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 3 · 25
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Indexes — Making a Query Faster, and What an Index Costs
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series3/_25/ when it is real.
 *
 *     zeus.bat koans learnsql series3 _25     (Windows)
 *     ./zeus.sh koans learnsql series3 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
