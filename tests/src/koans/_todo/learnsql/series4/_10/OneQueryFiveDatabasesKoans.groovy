package datazeus.learnsql.series4._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 4 · 10
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Northwind on Postgres, Oracle, SQL Server, MySQL & Db2 — One Query, Five Databases
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series4/_10/ when it is real.
 *
 *     zeus.bat koans learnsql series4 _10     (Windows)
 *     ./zeus.sh koans learnsql series4 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
...
class OneQueryFiveDatabasesKoans extends KoanBase {
