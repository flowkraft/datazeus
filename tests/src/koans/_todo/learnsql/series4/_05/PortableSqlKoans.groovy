package datazeus.learnsql.series4._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 4 · 05
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Portable Paging, Strings, Dates & UPSERT — One Query That Runs on Every Engine
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series4/_05/ when it is real.
 *
 *     zeus.bat koans learnsql series4 _05     (Windows)
 *     ./zeus.sh koans learnsql series4 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 * GOAL: write one query that runs on all five engines.
 * SQL: FETCH FIRST vs LIMIT vs TOP vs ROWNUM, string concatenation four ways, date arithmetic,
 * MERGE and the UPSERT variants, quoted identifiers and case folding.
 * Every item is a decision with a portable answer and a faster non-portable one. Give both and
 * say when each is right — a rule that only ever says "use the standard" is not usable advice.
 */
@Stepwise // walk the koans in order — once one fails, the rest wait
class PortableSqlKoans extends KoanBase {
