...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 1 · 30
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * GROUP BY — One Number per Customer, per Month, per Anything
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series1/_30/ when it is real.
 *
 *     zeus.bat koans learnsql series1 _30     (Windows)
 *     ./zeus.sh koans learnsql series1 _30    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
