...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 1 · 15
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * ORDER BY, LIMIT & FETCH FIRST — Sorting Rows and Keeping the Top Few
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series1/_15/ when it is real.
 *
 *     zeus.bat koans learnsql series1 _15     (Windows)
 *     ./zeus.sh koans learnsql series1 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
