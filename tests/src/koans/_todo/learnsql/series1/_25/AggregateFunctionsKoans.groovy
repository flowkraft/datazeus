...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 1 · 25
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * COUNT, SUM, AVG, MIN, MAX — Turning Many Rows Into One Number
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series1/_25/ when it is real.
 *
 *     zeus.bat koans learnsql series1 _25     (Windows)
 *     ./zeus.sh koans learnsql series1 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
