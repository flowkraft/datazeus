...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 1 · 35
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * HAVING vs WHERE — Why WHERE Can't Filter Your Totals
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series1/_35/ when it is real.
 *
 *     zeus.bat koans learnsql series1 _35     (Windows)
 *     ./zeus.sh koans learnsql series1 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
