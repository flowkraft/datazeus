...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 1 · 20
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Aliases, Expressions & DISTINCT — Make Messy Output Look Like a Report
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series1/_20/ when it is real.
 *
 *     zeus.bat koans learnsql series1 _20     (Windows)
 *     ./zeus.sh koans learnsql series1 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
