...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 2 · 00
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Multi-Table JOINs — Following the Data Across Three or More Tables
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series2/_00/ when it is real.
 *
 *     zeus.bat koans learnsql series2 _00     (Windows)
 *     ./zeus.sh koans learnsql series2 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
...
class MultiTableJoinsKoans extends KoanBase {
