package datazeus.learnsql.series2._22
 ...
 * src/koans/groovy/datazeus/learnsql/series2/_22/ when it is real.
 *
 *     zeus.bat koans learnsql series2 _22     (Windows)
 *     ./zeus.sh koans learnsql series2 _22    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 * The case does not appear in this episode (NONE). The KOANS: a view over products and categories, querying it,
 * replacing it, and the equivalence the rung asks for — the view returns exactly what its query returns; one
 * koan on summing from a view whose grain is not what its name suggests. Measure first.
 *
 * ── PLACE IN THE SERIES ─────────────────────────────────────────────────
