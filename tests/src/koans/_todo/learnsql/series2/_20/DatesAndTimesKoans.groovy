...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  SQL KOANS — Learn SQL · Series 2 · 20
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 ...
 * src/koans/groovy/datazeus/learnsql/series2/_20/ when it is real.
 *
 *     zeus.bat koans learnsql series2 _20     (Windows)
 *     ./zeus.sh koans learnsql series2 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
