package datazeus.datawarehousing.series3._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 3 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * From Warehouse to BI — Feeding Dashboards, Cubes and Extracts
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series3/_40/ when it is real.
 *
 *     zeus.bat koans datawarehousing series3 _40     (Windows)
 *     ./zeus.sh koans datawarehousing series3 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class WarehouseToBiKoans extends KoanBase {
