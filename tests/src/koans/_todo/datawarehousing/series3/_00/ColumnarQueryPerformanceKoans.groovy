package datazeus.datawarehousing.series3._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 3 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Query Performance on Columnar Engines — Reading the Plan Again
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series3/_00/ when it is real.
 *
 *     zeus.bat koans datawarehousing series3 _00     (Windows)
 *     ./zeus.sh koans datawarehousing series3 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ColumnarQueryPerformanceKoans extends KoanBase {
