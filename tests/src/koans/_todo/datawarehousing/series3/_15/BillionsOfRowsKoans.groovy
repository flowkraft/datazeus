package datazeus.datawarehousing.series3._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 3 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Billions of Rows — Partitions, Sharding & Distribution
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series3/_15/ when it is real.
 *
 *     zeus.bat koans datawarehousing series3 _15     (Windows)
 *     ./zeus.sh koans datawarehousing series3 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class BillionsOfRowsKoans extends KoanBase {
