package datazeus.datawarehousing.series3._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 3 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Benchmark — The Same Star Schema on DuckDB vs ClickHouse
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series3/_35/ when it is real.
 *
 *     zeus.bat koans datawarehousing series3 _35     (Windows)
 *     ./zeus.sh koans datawarehousing series3 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class BenchmarkDuckdbVsClickhouseKoans extends KoanBase {
