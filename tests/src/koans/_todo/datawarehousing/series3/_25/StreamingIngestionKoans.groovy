package datazeus.datawarehousing.series3._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 3 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Streaming Ingestion — Minutes Behind Instead of a Day
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series3/_25/ when it is real.
 *
 *     zeus.bat koans datawarehousing series3 _25     (Windows)
 *     ./zeus.sh koans datawarehousing series3 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class StreamingIngestionKoans extends KoanBase {
