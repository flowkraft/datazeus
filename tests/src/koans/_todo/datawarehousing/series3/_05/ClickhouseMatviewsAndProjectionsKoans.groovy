package datazeus.datawarehousing.series3._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 3 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Aggregating Materialized Views & Projections — ClickHouse Computing the Total at Insert Time
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series3/_05/ when it is real.
 *
 *     zeus.bat koans datawarehousing series3 _05     (Windows)
 *     ./zeus.sh koans datawarehousing series3 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `clickhouse` — ClickHouse, for anything that needs scale
 *
 ...
 */
@Stepwise
class ClickhouseMatviewsAndProjectionsKoans extends KoanBase {
