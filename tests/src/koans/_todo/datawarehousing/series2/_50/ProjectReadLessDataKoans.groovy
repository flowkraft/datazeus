package datazeus.datawarehousing.series2._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — The Same Question, Reading a Tenth of the Data
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_50/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _50     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectReadLessDataKoans extends KoanBase {
