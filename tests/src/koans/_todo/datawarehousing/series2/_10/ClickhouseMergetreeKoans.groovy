package datazeus.datawarehousing.series2._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * ClickHouse & MergeTree — Columnar Storage on a Server, at Scale
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_10/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _10     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ClickhouseMergetreeKoans extends KoanBase {
