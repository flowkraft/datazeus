package datazeus.datawarehousing.series2._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * DuckDB — An Analytical Warehouse That Runs Inside Your Process
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_05/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _05     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `duckdb` — embedded DuckDB
 *
 ...
 */
@Stepwise
class DuckdbKoans extends KoanBase {
