package datazeus.datawarehousing.series2._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Partitioning, Sort Keys & Data Skipping — Read Less, Answer Sooner
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_15/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _15     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class PartitioningAndSortKeysKoans extends KoanBase {
