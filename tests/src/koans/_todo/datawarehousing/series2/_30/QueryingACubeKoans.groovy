package datazeus.datawarehousing.series2._30
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 30
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Querying a Cube — Pick the Fields, Then Read the SQL It Wrote for You
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_30/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _30     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _30    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class QueryingACubeKoans extends KoanBase {
