package datazeus.datawarehousing.series2._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Star vs One Big Table on Columnar Engines — Measured on the Same Data
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_40/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _40     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class StarVsOneBigTableKoans extends KoanBase {
