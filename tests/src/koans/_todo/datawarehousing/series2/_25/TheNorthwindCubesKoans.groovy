package datazeus.datawarehousing.series2._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Reading Cubes Somebody Else Built — Sales, Inventory, Customers and HR
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_25/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _25     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class TheNorthwindCubesKoans extends KoanBase {
