package datazeus.datawarehousing.series2._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Columnar Storage — Why Analytics Loves Columns
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_00/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _00     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ColumnarStorageKoans extends KoanBase {
