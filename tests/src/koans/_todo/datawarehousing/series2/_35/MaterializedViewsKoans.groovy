package datazeus.datawarehousing.series2._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Materialized Views & Incremental Aggregation — Compute Once, Read Often
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_35/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _35     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class MaterializedViewsKoans extends KoanBase {
