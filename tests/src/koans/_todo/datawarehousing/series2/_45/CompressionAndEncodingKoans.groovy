package datazeus.datawarehousing.series2._45
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 45
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Compression & Encoding — Why the Same Table Is Ten Times Smaller Here
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_45/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _45     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _45    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CompressionAndEncodingKoans extends KoanBase {
