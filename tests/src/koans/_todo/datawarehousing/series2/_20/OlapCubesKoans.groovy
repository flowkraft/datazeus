package datazeus.datawarehousing.series2._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 2 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * The Semantic Layer — Dimensions, Measures and Hierarchies, Declared Once
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series2/_20/ when it is real.
 *
 *     zeus.bat koans datawarehousing series2 _20     (Windows)
 *     ./zeus.sh koans datawarehousing series2 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class OlapCubesKoans extends KoanBase {
