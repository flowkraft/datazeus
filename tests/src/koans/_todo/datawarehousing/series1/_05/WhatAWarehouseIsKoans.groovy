package datazeus.datawarehousing.series1._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_05/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _05     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class WhatAWarehouseIsKoans extends KoanBase {
