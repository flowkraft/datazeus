package datazeus.datawarehousing.series1._22
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 22
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Reconciling With the Source — Proving the Warehouse Agrees With the App
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_22/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _22     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _22    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   courses/datawarehousing/curriculum.yaml   the track's decisions
 *
 * ── THE RULES ───────────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ReconcilingWithTheSourceKoans extends KoanBase {
