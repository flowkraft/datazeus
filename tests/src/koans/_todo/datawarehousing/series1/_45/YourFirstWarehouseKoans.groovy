package datazeus.datawarehousing.series1._45
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 45
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — One Star Schema, Loaded and Queried
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_45/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _45     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _45    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class YourFirstWarehouseKoans extends KoanBase {
