package datazeus.datawarehousing.series1._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Time-Based Analysis — The Date Dimension Doing Real Work
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_40/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _40     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DateDimensionInPracticeKoans extends KoanBase {
