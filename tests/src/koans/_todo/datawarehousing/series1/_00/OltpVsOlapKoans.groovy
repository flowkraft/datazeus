package datazeus.datawarehousing.series1._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * OLTP vs OLAP — Two Workloads That Need Different Table Designs
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_00/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _00     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class OltpVsOlapKoans extends KoanBase {
