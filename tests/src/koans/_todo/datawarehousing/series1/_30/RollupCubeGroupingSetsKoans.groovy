package datazeus.datawarehousing.series1._30
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 30
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * ROLLUP, CUBE & GROUPING SETS — Subtotals the Standard Way
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_30/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _30     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _30    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class RollupCubeGroupingSetsKoans extends KoanBase {
