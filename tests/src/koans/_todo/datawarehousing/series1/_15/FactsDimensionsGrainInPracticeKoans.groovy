package datazeus.datawarehousing.series1._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Facts, Dimensions & Grain in Practice — Reading Someone Else's Warehouse
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_15/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _15     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class FactsDimensionsGrainInPracticeKoans extends KoanBase {
