package datazeus.datawarehousing.series1._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Pre-Aggregation — Summary Tables and Materialized Views
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_35/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _35     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class PreAggregationKoans extends KoanBase {
