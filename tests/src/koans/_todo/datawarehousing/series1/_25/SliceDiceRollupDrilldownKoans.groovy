package datazeus.datawarehousing.series1._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Slice, Dice, Roll-Up & Drill-Down — The Four Analytical Moves
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_25/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _25     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SliceDiceRollupDrilldownKoans extends KoanBase {
