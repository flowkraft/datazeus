package datazeus.datawarehousing.series1._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Warehousing · Series 1 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * The Star Schema from the Query Side — Why Analysts Like It
 *
 ...
 * src/koans/groovy/datazeus/datawarehousing/series1/_10/ when it is real.
 *
 *     zeus.bat koans datawarehousing series1 _10     (Windows)
 *     ./zeus.sh koans datawarehousing series1 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `cloudbeaver` — the SQL editor DataPallas ships
 *
 ...
 */
@Stepwise
class StarSchemaForAnalyticsKoans extends KoanBase {
