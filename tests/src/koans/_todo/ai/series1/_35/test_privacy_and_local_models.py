"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 1 · 35
╚══════════════════════════════════════════════════════════════════════════╝

Privacy & Local Models — Keeping Your Data Off Someone Else's Server

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series1/_35/ when it is real.

    zeus.bat koans ai series1 _35     (Windows)
    ./zeus.sh koans ai series1 _35    (macOS/Linux)
