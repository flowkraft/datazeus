"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 1 · 20
╚══════════════════════════════════════════════════════════════════════════╝

Prompt Patterns for Data — Few-Shot, Constraints and Guardrails

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series1/_20/ when it is real.

    zeus.bat koans ai series1 _20     (Windows)
    ./zeus.sh koans ai series1 _20    (macOS/Linux)
