"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 1 · 30
╚══════════════════════════════════════════════════════════════════════════╝

AI in the Query Editor — Explain, Refactor and Optimize an Existing Query

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series1/_30/ when it is real.

    zeus.bat koans ai series1 _30     (Windows)
    ./zeus.sh koans ai series1 _30    (macOS/Linux)
...
── WHAT THIS EPISODE'S RUNGS OBLIGE YOU TO WRITE ───────────────────────
  ...
  SURFACE `chat2db` — ask in plain English, read the SQL it wrote, see the answer
