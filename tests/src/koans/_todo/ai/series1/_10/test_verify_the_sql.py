"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 1 · 10
╚══════════════════════════════════════════════════════════════════════════╝

Verify the Answer — Checking the Generated Query Returns the Right Rows

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series1/_10/ when it is real.

    zeus.bat koans ai series1 _10     (Windows)
    ./zeus.sh koans ai series1 _10    (macOS/Linux)
