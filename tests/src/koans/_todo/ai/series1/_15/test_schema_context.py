"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 1 · 15
╚══════════════════════════════════════════════════════════════════════════╝

Schema Context — Why the Model Needs Your Tables, Not Just Your Question

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series1/_15/ when it is real.

    zeus.bat koans ai series1 _15     (Windows)
    ./zeus.sh koans ai series1 _15    (macOS/Linux)
