...
does not see. MOVE IT into src/koans/python/ai/series2/_35/ when it is real.

    zeus.bat koans ai series2 _35     (Windows)
    ./zeus.sh koans ai series2 _35    (macOS/Linux)
