"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 2 · 15
╚══════════════════════════════════════════════════════════════════════════╝

Semantic Search Over Northwind — Find Products by Meaning, Not LIKE

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series2/_15/ when it is real.

    zeus.bat koans ai series2 _15     (Windows)
    ./zeus.sh koans ai series2 _15    (macOS/Linux)
