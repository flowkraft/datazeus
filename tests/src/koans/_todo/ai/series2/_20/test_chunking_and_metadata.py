"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 2 · 20
╚══════════════════════════════════════════════════════════════════════════╝

Chunking & Metadata — The Settings That Decide Whether Retrieval Works

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series2/_20/ when it is real.

    zeus.bat koans ai series2 _20     (Windows)
    ./zeus.sh koans ai series2 _20    (macOS/Linux)
...
── WHAT THIS EPISODE'S RUNGS OBLIGE YOU TO WRITE ───────────────────────
  EVAL — score output against a known-good set and assert a THRESHOLD, not an
     exact string. The only place in the academy a koan may be statistical.
