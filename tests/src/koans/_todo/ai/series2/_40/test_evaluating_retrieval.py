"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 2 · 40
╚══════════════════════════════════════════════════════════════════════════╝

Evaluating Retrieval — Recall, Precision and a Test Set You Trust

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series2/_40/ when it is real.

    zeus.bat koans ai series2 _40     (Windows)
    ./zeus.sh koans ai series2 _40    (macOS/Linux)
