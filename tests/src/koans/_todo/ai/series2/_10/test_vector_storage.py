"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 2 · 10
╚══════════════════════════════════════════════════════════════════════════╝

Vector Storage Where Your Data Already Lives — pgvector and DuckDB vss

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series2/_10/ when it is real.

    zeus.bat koans ai series2 _10     (Windows)
    ./zeus.sh koans ai series2 _10    (macOS/Linux)
