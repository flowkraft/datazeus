"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 3 · 30
╚══════════════════════════════════════════════════════════════════════════╝

Fine-Tuning vs RAG vs Prompting — The Cheapest Thing That Actually Works

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series3/_30/ when it is real.

    zeus.bat koans ai series3 _30     (Windows)
    ./zeus.sh koans ai series3 _30    (macOS/Linux)
