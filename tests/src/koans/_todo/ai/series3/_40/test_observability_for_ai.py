"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 3 · 40
╚══════════════════════════════════════════════════════════════════════════╝

Observability for AI Features — Log the Prompt, the Query and the Answer

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series3/_40/ when it is real.

    zeus.bat koans ai series3 _40     (Windows)
    ./zeus.sh koans ai series3 _40    (macOS/Linux)
