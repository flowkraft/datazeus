"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 3 · 00
╚══════════════════════════════════════════════════════════════════════════╝

Tools & Function Calling — Let the Model Run a Query, Under Supervision

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series3/_00/ when it is real.

    zeus.bat koans ai series3 _00     (Windows)
    ./zeus.sh koans ai series3 _00    (macOS/Linux)
