"""
╔══════════════════════════════════════════════════════════════════════════╗
║  KOANS — AI for Data · Series 3 · 15
╚══════════════════════════════════════════════════════════════════════════╝

Eval Harnesses — Score Generated SQL Against Known-Good Answers

TODO — NOT A KOAN YET. Lives under src/koans/_todo/, which the runner does not mount and zeus
does not see. MOVE IT into src/koans/python/ai/series3/_15/ when it is real.

    zeus.bat koans ai series3 _15     (Windows)
    ./zeus.sh koans ai series3 _15    (macOS/Linux)
