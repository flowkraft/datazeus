package datazeus.bi.series1._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Honest Charts — Axes, Scales and How Not to Mislead
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_40/ when it is real.
 *
 *     zeus.bat koans bi series1 _40     (Windows)
 *     ./zeus.sh koans bi series1 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class HonestChartsKoans extends KoanBase {
