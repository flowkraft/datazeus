package datazeus.bi.series1._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Pie, Donut & Part-to-Whole — And Why to Use Them Sparingly
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_25/ when it is real.
 *
 *     zeus.bat koans bi series1 _25     (Windows)
 *     ./zeus.sh koans bi series1 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class PartToWholeKoans extends KoanBase {
