package datazeus.bi.series1._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Colour — Meaning, Scales and Accessibility
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_35/ when it is real.
 *
 *     zeus.bat koans bi series1 _35     (Windows)
 *     ./zeus.sh koans bi series1 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ColourAndAccessibilityKoans extends KoanBase {
