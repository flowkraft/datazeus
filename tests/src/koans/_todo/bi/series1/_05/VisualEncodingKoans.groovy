package datazeus.bi.series1._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Visual Encoding — Position, Length, Colour and What the Eye Reads First
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_05/ when it is real.
 *
 *     zeus.bat koans bi series1 _05     (Windows)
 *     ./zeus.sh koans bi series1 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class VisualEncodingKoans extends KoanBase {
