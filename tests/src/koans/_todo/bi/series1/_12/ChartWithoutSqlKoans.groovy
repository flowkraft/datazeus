package datazeus.bi.series1._12
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 12
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Building a Chart Without SQL — Pick the Data, Pick the Shape
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_12/ when it is real.
 *
 *     zeus.bat koans bi series1 _12     (Windows)
 *     ./zeus.sh koans bi series1 _12    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `cube` — the cube designer
 *
 ...
 */
@Stepwise
class ChartWithoutSqlKoans extends KoanBase {
