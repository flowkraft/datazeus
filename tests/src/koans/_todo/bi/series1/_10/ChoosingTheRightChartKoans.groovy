package datazeus.bi.series1._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Choosing the Right Chart — Match the Chart to the Question
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_10/ when it is real.
 *
 *     zeus.bat koans bi series1 _10     (Windows)
 *     ./zeus.sh koans bi series1 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ChoosingTheRightChartKoans extends KoanBase {
