package datazeus.bi.series1._45
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 1 · 45
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — From a Query to a Chart Someone Else Can Read
 *
 ...
 * src/koans/groovy/datazeus/bi/series1/_45/ when it is real.
 *
 *     zeus.bat koans bi series1 _45     (Windows)
 *     ./zeus.sh koans bi series1 _45    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class YourFirstChartKoans extends KoanBase {
