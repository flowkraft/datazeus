package datazeus.bi.series2._47
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 47
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Custom SQL for One Widget — What to Do When Point-and-Click Runs Out
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_47/ when it is real.
 *
 *     zeus.bat koans bi series2 _47     (Windows)
 *     ./zeus.sh koans bi series2 _47    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class WhenClickingRunsOutKoans extends KoanBase {
