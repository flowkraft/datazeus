package datazeus.bi.series2._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Metrics & KPIs — Defining What 'Good' Means, Once
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_35/ when it is real.
 *
 *     zeus.bat koans bi series2 _35     (Windows)
 *     ./zeus.sh koans bi series2 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class MetricsAndKpisKoans extends KoanBase {
