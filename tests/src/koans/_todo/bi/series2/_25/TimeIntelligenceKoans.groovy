package datazeus.bi.series2._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Time Intelligence — MTD, YTD, YoY, Moving Averages & Sparklines
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_25/ when it is real.
 *
 *     zeus.bat koans bi series2 _25     (Windows)
 *     ./zeus.sh koans bi series2 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class TimeIntelligenceKoans extends KoanBase {
