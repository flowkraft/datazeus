package datazeus.bi.series2._45
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 45
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Filters, Drill-Down & Cross-Filtering — Let People Ask the Next Question
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_45/ when it is real.
 *
 *     zeus.bat koans bi series2 _45     (Windows)
 *     ./zeus.sh koans bi series2 _45    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `web-components` — rb-value / rb-chart / rb-tabulator / rb-pivot-table / rb-parameters / rb-report
 *
 ...
 */
@Stepwise
class FiltersAndDrillDownKoans extends KoanBase {
