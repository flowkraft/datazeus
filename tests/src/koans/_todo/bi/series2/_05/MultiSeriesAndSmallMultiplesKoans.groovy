package datazeus.bi.series2._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Multi-Series & Small Multiples — Compare Without Clutter
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_05/ when it is real.
 *
 *     zeus.bat koans bi series2 _05     (Windows)
 *     ./zeus.sh koans bi series2 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   courses/bi/curriculum.yaml   the track's decisions
 *
 * ── THE RULES ───────────────────────────────────────────────────────────
 ...
 *   SURFACE `canvas` — the Data Canvas — drop a cube, tick fields, "Visualize as", Finetune, Display, Publish
 *
 ...
 */
@Stepwise
class MultiSeriesAndSmallMultiplesKoans extends KoanBase {
