package datazeus.bi.series2._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Sankey & Scatter — Flows, Relationships and Two Measures at Once
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_20/ when it is real.
 *
 *     zeus.bat koans bi series2 _20     (Windows)
 *     ./zeus.sh koans bi series2 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class FlowsAndCorrelationKoans extends KoanBase {
