package datazeus.bi.series2._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Distributions — Histograms & Box Plots, Beyond the Average
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_10/ when it is real.
 *
 *     zeus.bat koans bi series2 _10     (Windows)
 *     ./zeus.sh koans bi series2 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DistributionsKoans extends KoanBase {
