package datazeus.bi.series2._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Geospatial — Choropleth Maps (Sales by ShipCountry)
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_15/ when it is real.
 *
 *     zeus.bat koans bi series2 _15     (Windows)
 *     ./zeus.sh koans bi series2 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class GeospatialKoans extends KoanBase {
