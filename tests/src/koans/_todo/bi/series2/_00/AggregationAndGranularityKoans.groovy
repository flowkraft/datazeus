package datazeus.bi.series2._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 2 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Aggregation & Granularity — What One Mark Actually Represents
 *
 ...
 * src/koans/groovy/datazeus/bi/series2/_00/ when it is real.
 *
 *     zeus.bat koans bi series2 _00     (Windows)
 *     ./zeus.sh koans bi series2 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class AggregationAndGranularityKoans extends KoanBase {
