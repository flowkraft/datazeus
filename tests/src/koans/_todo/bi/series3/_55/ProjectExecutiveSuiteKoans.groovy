package datazeus.bi.series3._55
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 55
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — A Northwind Executive Suite: Cube → Dashboards → Delivery
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_55/ when it is real.
 *
 *     zeus.bat koans bi series3 _55     (Windows)
 *     ./zeus.sh koans bi series3 _55    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `report-config` — the data script, HTML template and per-component config on disk
 *
 ...
 */
@Stepwise
class ProjectExecutiveSuiteKoans extends KoanBase {
