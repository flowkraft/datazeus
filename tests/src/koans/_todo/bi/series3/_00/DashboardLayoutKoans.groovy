package datazeus.bi.series3._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Dashboard Layout — Information Hierarchy and What Belongs at the Top
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_00/ when it is real.
 *
 *     zeus.bat koans bi series3 _00     (Windows)
 *     ./zeus.sh koans bi series3 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DashboardLayoutKoans extends KoanBase {
