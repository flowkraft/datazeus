package datazeus.bi.series3._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Operational & Pixel-Perfect Reporting — When the Layout Is the Requirement
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_20/ when it is real.
 *
 *     zeus.bat koans bi series3 _20     (Windows)
 *     ./zeus.sh koans bi series3 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class OperationalReportingKoans extends KoanBase {
