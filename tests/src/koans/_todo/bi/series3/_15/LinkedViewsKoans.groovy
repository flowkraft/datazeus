package datazeus.bi.series3._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Linked Views & Cross-Widget Drill-Down — Click a Bar, Filter the Page
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_15/ when it is real.
 *
 *     zeus.bat koans bi series3 _15     (Windows)
 *     ./zeus.sh koans bi series3 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class LinkedViewsKoans extends KoanBase {
