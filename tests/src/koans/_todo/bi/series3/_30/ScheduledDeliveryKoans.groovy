package datazeus.bi.series3._30
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 30
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Scheduled Delivery — Email, Portals and Files, on a Schedule
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_30/ when it is real.
 *
 *     zeus.bat koans bi series3 _30     (Windows)
 *     ./zeus.sh koans bi series3 _30    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ScheduledDeliveryKoans extends KoanBase {
