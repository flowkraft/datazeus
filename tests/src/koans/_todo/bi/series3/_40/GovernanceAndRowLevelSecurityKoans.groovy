package datazeus.bi.series3._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Governance & Row-Level Security — Same Numbers for Everyone, and Only Their Rows
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_40/ when it is real.
 *
 *     zeus.bat koans bi series3 _40     (Windows)
 *     ./zeus.sh koans bi series3 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class GovernanceAndRowLevelSecurityKoans extends KoanBase {
