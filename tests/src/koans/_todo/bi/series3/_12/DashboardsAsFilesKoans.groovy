package datazeus.bi.series3._12
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 12
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Dashboards as Files — Version Control, Review and Rebuilding From Scratch
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_12/ when it is real.
 *
 *     zeus.bat koans bi series3 _12     (Windows)
 *     ./zeus.sh koans bi series3 _12    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DashboardsAsFilesKoans extends KoanBase {
