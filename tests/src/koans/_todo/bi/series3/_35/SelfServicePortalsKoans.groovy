package datazeus.bi.series3._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Self-Service Portals — Secure, Personalized Access Without a Ticket
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_35/ when it is real.
 *
 *     zeus.bat koans bi series3 _35     (Windows)
 *     ./zeus.sh koans bi series3 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SelfServicePortalsKoans extends KoanBase {
