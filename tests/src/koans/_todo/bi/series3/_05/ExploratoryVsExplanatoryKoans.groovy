package datazeus.bi.series3._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Exploratory vs Explanatory — Design for Who's Looking
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_05/ when it is real.
 *
 *     zeus.bat koans bi series3 _05     (Windows)
 *     ./zeus.sh koans bi series3 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ExploratoryVsExplanatoryKoans extends KoanBase {
