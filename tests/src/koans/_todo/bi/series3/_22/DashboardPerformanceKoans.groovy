package datazeus.bi.series3._22
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 22
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Dashboard Performance — Why It Takes Forty Seconds, and What to Cache
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_22/ when it is real.
 *
 *     zeus.bat koans bi series3 _22     (Windows)
 *     ./zeus.sh koans bi series3 _22    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DashboardPerformanceKoans extends KoanBase {
