package datazeus.bi.series3._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — BI & Data Visualization · Series 3 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Build a Multi-Widget Dashboard — Layout, Filters and One Story
 *
 ...
 * src/koans/groovy/datazeus/bi/series3/_10/ when it is real.
 *
 *     zeus.bat koans bi series3 _10     (Windows)
 *     ./zeus.sh koans bi series3 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class BuildADashboardKoans extends KoanBase {
