package datazeus.javagroovy.series1._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  JVM KOANS — Java & Groovy for Data · Series 1 · 05
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Records and Collections — Holding Rows and Tables in Memory
 *
 *     zeus.bat koans javagroovy series1 _05     (Windows)
 *     ./zeus.sh koans javagroovy series1 _05    (macOS/Linux)
 *
...
class RecordsAndCollectionsKoans extends JvmKoanBase {
