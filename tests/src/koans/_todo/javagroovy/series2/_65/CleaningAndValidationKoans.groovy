package datazeus.javagroovy.series2._65
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  JVM KOANS — Java & Groovy for Data · Series 2 · 65
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Cleaning and Validating — Checking Data Before You Load It
 *
 *     zeus.bat koans javagroovy series2 _65     (Windows)
 *     ./zeus.sh koans javagroovy series2 _65    (macOS/Linux)
 *
 ...
 * GOAL: decide what to do with a bad row before it reaches your database.
 * CONSTRUCTS: validation as a pure function returning Either/Result, reject vs quarantine vs
 * default, collecting errors instead of throwing on the first one.
 * The last episode before the project because it is what makes the project trustworthy.
 */
@Stepwise // walk them in order — once one fails, the rest wait
class CleaningAndValidationKoans extends JvmKoanBase {
