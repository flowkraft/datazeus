package datazeus.javagroovy.series2._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  JVM KOANS — Java & Groovy for Data · Series 2 · 50
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * HTTP and JSON — Reading Data From an API With HttpClient and Jackson
 *
 *     zeus.bat koans javagroovy series2 _50     (Windows)
 *     ./zeus.sh koans javagroovy series2 _50    (macOS/Linux)
 *
...
class ApisAndJsonKoans extends JvmKoanBase {
