package datazeus.javagroovy.series2._70
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  JVM KOANS — Java & Groovy for Data · Series 2 · 70
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Project — One Answer From a CSV, a Database and an API
 *
 *     zeus.bat koans javagroovy series2 _70     (Windows)
 *     ./zeus.sh koans javagroovy series2 _70    (macOS/Linux)
 *
...
class ProjectThreeSourcesKoans extends JvmKoanBase {
