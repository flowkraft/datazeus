package datazeus.javagroovy.series2._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  JVM KOANS — Java & Groovy for Data · Series 2 · 15
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * PreparedStatement — Passing Values Safely Into a Query
 *
 *     zeus.bat koans javagroovy series2 _15     (Windows)
 *     ./zeus.sh koans javagroovy series2 _15    (macOS/Linux)
 *
 ...
 * CONSTRUCTS: PreparedStatement setString/setInt/setTimestamp, the ? placeholder, batch reuse.
 * KOAN (predict + complete): the concatenated version and the parameterised version return the
 * same rows for ordinary input — then a value containing a quote separates them. Correctness
 * alone cannot tell them apart, which is exactly why people ship the wrong one.
 */
@Stepwise // walk them in order — once one fails, the rest wait
class ParameterizedQueriesKoans extends JvmKoanBase {
