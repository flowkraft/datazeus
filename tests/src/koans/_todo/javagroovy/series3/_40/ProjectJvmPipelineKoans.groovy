package datazeus.javagroovy.series3._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════╗
 * ║  JVM KOANS — Java & Groovy for Data · Series 3 · 40
 * ╚══════════════════════════════════════════════════════════════════════╝
 *
 * Project — A Job That Reads, Transforms, Loads and Reports
 *
 *     zeus.bat koans javagroovy series3 _40     (Windows)
 *     ./zeus.sh koans javagroovy series3 _40    (macOS/Linux)
 *
...
class ProjectJvmPipelineKoans extends JvmKoanBase {
