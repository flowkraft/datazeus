"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 25
╚══════════════════════════════════════════════════════════════════════════╝

Select, Filter & Sort — The SQL Ideas You Know, in Python Syntax
...
src/koans/python/series1/_25/ when it is real.

    zeus.bat koans python series1 _25     (Windows)
    ./zeus.sh koans python series1 _25    (macOS/Linux)
