"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 45
╚══════════════════════════════════════════════════════════════════════════╝

Project — From a Messy CSV to a Clean Table
...
src/koans/python/series1/_45/ when it is real.

    zeus.bat koans python series1 _45     (Windows)
    ./zeus.sh koans python series1 _45    (macOS/Linux)
