"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 05
╚══════════════════════════════════════════════════════════════════════════╝

Strings, Numbers, Lists & Dicts — The Four Types You Use in Every Script
...
src/koans/python/series1/_05/ when it is real.

    zeus.bat koans python series1 _05     (Windows)
    ./zeus.sh koans python series1 _05    (macOS/Linux)
