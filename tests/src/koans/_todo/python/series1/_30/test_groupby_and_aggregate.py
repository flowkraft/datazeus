"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 30
╚══════════════════════════════════════════════════════════════════════════╝

groupby & Aggregate — GROUP BY Without the Database
...
src/koans/python/series1/_30/ when it is real.

    zeus.bat koans python series1 _30     (Windows)
    ./zeus.sh koans python series1 _30    (macOS/Linux)
