"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 20
╚══════════════════════════════════════════════════════════════════════════╝

DataFrames — pandas and polars, and Which to Reach For
...
src/koans/python/series1/_20/ when it is real.

    zeus.bat koans python series1 _20     (Windows)
    ./zeus.sh koans python series1 _20    (macOS/Linux)
...
GOAL: know what a DataFrame gives you, and which library to reach for.
LIBRARIES: pandas.DataFrame, polars.DataFrame, and an honest comparison.
CHOOSE-KOAN: the same task in both. Not "polars is faster" — the decision is eager vs lazy, API
familiarity, and what the rest of your team already reads. Series 3 · 35 argues the scale case.
"""
