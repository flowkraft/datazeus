"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 40
╚══════════════════════════════════════════════════════════════════════════╝

Missing Data & dtypes — NaN, None and Getting the Column Type Right
...
src/koans/python/series1/_40/ when it is real.

    zeus.bat koans python series1 _40     (Windows)
    ./zeus.sh koans python series1 _40    (macOS/Linux)
