"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 1 · 00
╚══════════════════════════════════════════════════════════════════════════╝
...
src/koans/python/series1/_00/ when it is real.

    zeus.bat koans python series1 _00     (Windows)
    ./zeus.sh koans python series1 _00    (macOS/Linux)
