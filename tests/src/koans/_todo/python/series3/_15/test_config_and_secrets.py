"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 3 · 15
╚══════════════════════════════════════════════════════════════════════════╝

Config & Secrets — Keeping Passwords Out of Your Code
...
src/koans/python/series3/_15/ when it is real.

    zeus.bat koans python series3 _15     (Windows)
    ./zeus.sh koans python series3 _15    (macOS/Linux)
...
THIS LESSON'S RUNGS: koan:process:tool, koan:capture
DATASET: none
