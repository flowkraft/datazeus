"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 3 · 10
╚══════════════════════════════════════════════════════════════════════════╝

argparse & CLI Scripts — Turning a Notebook Into a Job You Can Run
...
src/koans/python/series3/_10/ when it is real.

    zeus.bat koans python series3 _10     (Windows)
    ./zeus.sh koans python series3 _10    (macOS/Linux)
