"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 3 · 45
╚══════════════════════════════════════════════════════════════════════════╝

Project — A Tested Python Job That Loads Northwind End to End
...
src/koans/python/series3/_45/ when it is real.

    zeus.bat koans python series3 _45     (Windows)
    ./zeus.sh koans python series3 _45    (macOS/Linux)
...
THIS LESSON'S RUNGS: koan:author, koan:process:tool
DATASET: northwind
