"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 3 · 35
╚══════════════════════════════════════════════════════════════════════════╝

polars & Lazy Evaluation — When pandas Runs Out of Room
...
src/koans/python/series3/_35/ when it is real.

    zeus.bat koans python series3 _35     (Windows)
    ./zeus.sh koans python series3 _35    (macOS/Linux)
...
THIS LESSON'S RUNGS: koan:count:rows-held, koan:choose
DATASET: generated
