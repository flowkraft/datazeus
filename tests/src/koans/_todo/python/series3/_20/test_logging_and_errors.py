"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 3 · 20
╚══════════════════════════════════════════════════════════════════════════╝

Logging & Error Handling — What to Log When a Job Fails
...
src/koans/python/series3/_20/ when it is real.

    zeus.bat koans python series3 _20     (Windows)
    ./zeus.sh koans python series3 _20    (macOS/Linux)
