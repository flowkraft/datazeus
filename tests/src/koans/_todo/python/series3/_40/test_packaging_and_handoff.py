"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 3 · 40
╚══════════════════════════════════════════════════════════════════════════╝

Packaging & Hand-Off — Making It Runnable by Someone Else
...
src/koans/python/series3/_40/ when it is real.

    zeus.bat koans python series3 _40     (Windows)
    ./zeus.sh koans python series3 _40    (macOS/Linux)
