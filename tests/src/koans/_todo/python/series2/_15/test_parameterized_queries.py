"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 15
╚══════════════════════════════════════════════════════════════════════════╝

Parameterized Queries — Passing Values Safely Into a Query
...
src/koans/python/series2/_15/ when it is real.

    zeus.bat koans python series2 _15     (Windows)
    ./zeus.sh koans python series2 _15    (macOS/Linux)
