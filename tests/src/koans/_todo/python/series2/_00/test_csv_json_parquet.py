"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 00
╚══════════════════════════════════════════════════════════════════════════╝

CSV, JSON & Parquet — Choosing a File Format, and Why Parquet Usually Wins
...
src/koans/python/series2/_00/ when it is real.

    zeus.bat koans python series2 _00     (Windows)
    ./zeus.sh koans python series2 _00    (macOS/Linux)
