"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 30
╚══════════════════════════════════════════════════════════════════════════╝

Cleaning & Validation — Types, Ranges and Rows You Should Reject
...
src/koans/python/series2/_30/ when it is real.

    zeus.bat koans python series2 _30     (Windows)
    ./zeus.sh koans python series2 _30    (macOS/Linux)
