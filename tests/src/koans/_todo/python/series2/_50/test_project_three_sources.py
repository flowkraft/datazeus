"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 50
╚══════════════════════════════════════════════════════════════════════════╝

Project — One Answer From a CSV, a Database and an API
...
src/koans/python/series2/_50/ when it is real.

    zeus.bat koans python series2 _50     (Windows)
    ./zeus.sh koans python series2 _50    (macOS/Linux)
...
THIS LESSON'S RUNGS: koan:author, koan:count:rows-held
DATASET: northwind
