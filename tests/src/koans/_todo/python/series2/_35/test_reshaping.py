"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 35
╚══════════════════════════════════════════════════════════════════════════╝

pivot, melt & Reshape — Moving Data Between Wide and Long
...
src/koans/python/series2/_35/ when it is real.

    zeus.bat koans python series2 _35     (Windows)
    ./zeus.sh koans python series2 _35    (macOS/Linux)
