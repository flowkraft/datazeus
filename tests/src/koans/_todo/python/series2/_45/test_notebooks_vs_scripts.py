"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 45
╚══════════════════════════════════════════════════════════════════════════╝

Notebooks vs Scripts — Where Each One Belongs
...
src/koans/python/series2/_45/ when it is real.

    zeus.bat koans python series2 _45     (Windows)
    ./zeus.sh koans python series2 _45    (macOS/Linux)
