"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 20
╚══════════════════════════════════════════════════════════════════════════╝

HTTP APIs & JSON — Fetching Data With Pagination, Retries and Rate Limits
...
src/koans/python/series2/_20/ when it is real.

    zeus.bat koans python series2 _20     (Windows)
    ./zeus.sh koans python series2 _20    (macOS/Linux)
...
THIS LESSON'S RUNGS: koan:complete, koan:count:queries
DATASET: api-stub
