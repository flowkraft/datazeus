"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 10
╚══════════════════════════════════════════════════════════════════════════╝

psycopg & SQLAlchemy Core — Querying PostgreSQL from Python
...
src/koans/python/series2/_10/ when it is real.

    zeus.bat koans python series2 _10     (Windows)
    ./zeus.sh koans python series2 _10    (macOS/Linux)
