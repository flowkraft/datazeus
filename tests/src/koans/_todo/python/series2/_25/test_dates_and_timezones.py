"""
╔══════════════════════════════════════════════════════════════════════════╗
║  PYTHON KOANS — Python for Data · Series 2 · 25
╚══════════════════════════════════════════════════════════════════════════╝

Dates, Times & Time Zones — Storing and Comparing Moments Correctly
...
src/koans/python/series2/_25/ when it is real.

    zeus.bat koans python series2 _25     (Windows)
    ./zeus.sh koans python series2 _25    (macOS/Linux)
