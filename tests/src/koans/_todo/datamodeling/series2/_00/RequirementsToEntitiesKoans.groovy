package datazeus.datamodeling.series2._00
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 2 · 00 From a Brief to a Table List
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series2 _00     (Windows)
 *     ./zeus.sh koans datamodeling series2 _00    (macOS/Linux)
 *
...
class RequirementsToEntitiesKoans extends SchemaKoanBase {
