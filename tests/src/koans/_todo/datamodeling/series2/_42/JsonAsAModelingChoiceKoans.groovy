package datazeus.datamodeling.series2._42
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 2 · 42 JSON Columns
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series2 _42     (Windows)
 *     ./zeus.sh koans datamodeling series2 _42    (macOS/Linux)
 *
...
class JsonAsAModelingChoiceKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:choose, koan:diagnose):
    //
