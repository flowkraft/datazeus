package datazeus.datamodeling.series2._27
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 2 · 27 created_at, updated_by & deleted_at
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series2 _27     (Windows)
 *     ./zeus.sh koans datamodeling series2 _27    (macOS/Linux)
 *
...
class SoftDeletesAndAuditColumnsKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:predict):
    //
