package datazeus.datamodeling.series2._35
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 2 · 35 BCNF & When to Stop Normalizing
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series2 _35     (Windows)
 *     ./zeus.sh koans datamodeling series2 _35    (macOS/Linux)
 *
...
class BcnfAndWhenToStopKoans extends SchemaKoanBase {
