package datazeus.datamodeling.series2._15
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 2 · 15 Many-to-Many With Attributes
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series2 _15     (Windows)
 *     ./zeus.sh koans datamodeling series2 _15    (macOS/Linux)
 *
...
class ManyToManyWithAttributesKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:complete):
    //
