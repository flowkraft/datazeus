package datazeus.datamodeling.series2._50
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 2 · 50 Schema Evolution
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series2 _50     (Windows)
 *     ./zeus.sh koans datamodeling series2 _50    (macOS/Linux)
 *
 ...
 *
 * THIS LESSON'S RUNGS: koan:migration
 *
...
class SchemaEvolutionKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:migration):
    //
