...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 1 · 10 Grain & Primary Keys
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series1 _10     (Windows)
 *     ./zeus.sh koans datamodeling series1 _10    (macOS/Linux)
 *
 ...
 *
 * THIS LESSON'S RUNGS: koan:diagnose, koan:predict
 *
...
class GrainAndPrimaryKeysKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:diagnose, koan:predict):
    //
