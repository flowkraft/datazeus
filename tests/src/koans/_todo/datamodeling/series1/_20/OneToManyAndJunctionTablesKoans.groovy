...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 1 · 20 One-to-Many & Many-to-Many
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series1 _20     (Windows)
 *     ./zeus.sh koans datamodeling series1 _20    (macOS/Linux)
 *
 ...
 * GOAL: model both cardinalities without putting a list in a column.
 * MODELS: 1:M via a foreign key, M:N via a junction table, composite PK on the junction.
 *
 * Order Details is a textbook junction WITH attributes (Quantity, Discount, UnitPrice).
 * Do not teach the pure junction as the normal case and the attributed one as exotic — in
 * real schemas the attributed junction is the common one. S2/15 goes deeper.
 *
...
class OneToManyAndJunctionTablesKoans extends SchemaKoanBase {
