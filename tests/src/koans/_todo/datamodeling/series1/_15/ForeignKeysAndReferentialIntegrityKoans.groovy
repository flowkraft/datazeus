...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 1 · 15 Foreign Keys & Referential Integrity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series1 _15     (Windows)
 *     ./zeus.sh koans datamodeling series1 _15    (macOS/Linux)
 *
...
class ForeignKeysAndReferentialIntegrityKoans extends SchemaKoanBase {
