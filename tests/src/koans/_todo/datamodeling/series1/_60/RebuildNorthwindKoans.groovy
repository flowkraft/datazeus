package datazeus.datamodeling.series1._60
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 1 · 60 Rebuild Northwind's Integrity Layer
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series1 _60     (Windows)
 *     ./zeus.sh koans datamodeling series1 _60    (macOS/Linux)
 *
...
class RebuildNorthwindKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:author):
    //
