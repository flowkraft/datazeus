...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 1 · 05 Entities, Attributes & Relationships
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series1 _05     (Windows)
 *     ./zeus.sh koans datamodeling series1 _05    (macOS/Linux)
 *
 ...
 * GOAL: read an ER diagram and say back what the business does.
 * MODELS: entity, attribute, relationship, cardinality, optionality, Crow's Foot.
 *
 * The reading episode. Northwind's ER diagram, walked entity by entity, in the ER Diagram tab.
 * COST beat: note that the diagram is INFERRED — the shipped DuckDB declares no FKs at all,
 * so what is drawn comes from names and data, not from the database asserting anything. That
 * is the itch episode 15 scratches, and it is the honest reason Series 1 exists.
 *
...
class EntitiesAndRelationshipsKoans extends SchemaKoanBase {
