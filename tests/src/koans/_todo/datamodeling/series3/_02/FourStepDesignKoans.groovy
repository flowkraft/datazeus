package datazeus.datamodeling.series3._02
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 02 Fact Grain & Additivity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * The Four-Step Design — Pick the Process, Declare the Grain, Then Dimensions and Facts
 *
 *     zeus.bat koans datamodeling series3 _02     (Windows)
 *     ./zeus.sh koans datamodeling series3 _02    (macOS/Linux)
 *
...
class FourStepDesignKoans extends SchemaKoanBase {
