package datazeus.datamodeling.series3._35
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 35 Data Vault 2.0
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _35     (Windows)
 *     ./zeus.sh koans datamodeling series3 _35    (macOS/Linux)
 *
 ...
 * GOAL: judge whether the extra machinery is worth it.
 * MODELS: hubs, links, satellites, and the auditability argument.
 *
 * Choose-koan against star: when scale and auditability actually demand hubs/links/satellites — and when they do not.
 *
...
class DataVaultKoans extends SchemaKoanBase {
