package datazeus.datamodeling.series3._20
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 20 Fact Grain & Additivity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _20     (Windows)
 *     ./zeus.sh koans datamodeling series3 _20    (macOS/Linux)
 *
...
class GrainAndAdditivityKoans extends SchemaKoanBase {
