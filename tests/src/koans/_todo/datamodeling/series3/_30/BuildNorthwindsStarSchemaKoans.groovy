package datazeus.datamodeling.series3._30
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 30 Build Northwind's Star Schema
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _30     (Windows)
 *     ./zeus.sh koans datamodeling series3 _30    (macOS/Linux)
 *
 ...
 * GOAL: build the star, hands-on.
 * MODELS: star.sql: dimensions first, then the fact.
 *
 * Author-rung, hands-on in DuckDB. The dry run for the project.
 *
...
class BuildNorthwindsStarSchemaKoans extends SchemaKoanBase {
