package datazeus.datamodeling.series3._28
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 28 Fact Grain & Additivity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * Bridge Tables — When One Fact Row Belongs to Several Dimension Rows
 *
 *     zeus.bat koans datamodeling series3 _28     (Windows)
 *     ./zeus.sh koans datamodeling series3 _28    (macOS/Linux)
 *
...
class BridgeTablesKoans extends SchemaKoanBase {
