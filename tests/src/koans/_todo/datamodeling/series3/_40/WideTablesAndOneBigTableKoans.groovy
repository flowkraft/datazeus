package datazeus.datamodeling.series3._40
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 40 Wide Tables & One Big Table
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _40     (Windows)
 *     ./zeus.sh koans datamodeling series3 _40    (macOS/Linux)
 *
 ...
 * GOAL: judge the analytics-engineering shift honestly.
 * MODELS: wide tables, one big table, and what columnar storage changed.
 *
 * Current and honest about where the field moved. Columnar storage changed the arithmetic; say why.
 *
...
class WideTablesAndOneBigTableKoans extends SchemaKoanBase {
