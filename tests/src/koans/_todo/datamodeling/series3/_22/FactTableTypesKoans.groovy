package datazeus.datamodeling.series3._22
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 22 Fact Grain & Additivity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * Fact Table Types — One Row per Event, per Period, or per Pipeline
 *
 *     zeus.bat koans datamodeling series3 _22     (Windows)
 *     ./zeus.sh koans datamodeling series3 _22    (macOS/Linux)
 *
...
class FactTableTypesKoans extends SchemaKoanBase {
