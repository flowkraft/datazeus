package datazeus.datamodeling.series3._27
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 27 Fact Grain & Additivity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * Role-Playing, Degenerate & Junk Dimensions — One Date Table Used Three Ways
 *
 *     zeus.bat koans datamodeling series3 _27     (Windows)
 *     ./zeus.sh koans datamodeling series3 _27    (macOS/Linux)
 *
...
class RolePlayingAndSmallDimensionsKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:predict, koan:diagnose):
    //
