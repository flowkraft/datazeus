package datazeus.datamodeling.series3._32
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 32 Fact Grain & Additivity
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * Conformed Dimensions — Comparing Sales and Inventory on the Same Product Table
 *
 *     zeus.bat koans datamodeling series3 _32     (Windows)
 *     ./zeus.sh koans datamodeling series3 _32    (macOS/Linux)
 *
...
class ConformedDimensionsKoans extends SchemaKoanBase {
