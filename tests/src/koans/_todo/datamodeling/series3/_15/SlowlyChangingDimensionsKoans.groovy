package datazeus.datamodeling.series3._15
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 15 Slowly Changing Dimensions
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _15     (Windows)
 *     ./zeus.sh koans datamodeling series3 _15    (macOS/Linux)
 *
 ...
 * GOAL: choose how a dimension remembers its past.
 * MODELS: SCD Type 1, 2 and 3, valid_from/valid_to, surrogate keys.
 *
 * Type 1, 2, 3 and WHICH TO PICK — the picking is the episode; the types are ten minutes.
 * Boundary: Data Warehousing S3/10 covers QUERYING SCD history correctly. Here it is design.
 *
...
class SlowlyChangingDimensionsKoans extends SchemaKoanBase {
