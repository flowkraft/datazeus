package datazeus.datamodeling.series3._50
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 50
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _50     (Windows)
 *     ./zeus.sh koans datamodeling series3 _50    (macOS/Linux)
 *
 ...
 *
 * THIS LESSON'S RUNGS: koan:reconcile, koan:author
 *
...
class ProjectOltpToStarKoans extends SchemaKoanBase {

    // TODO: koans, in the same order as the lesson's beats.
    //
    // Sketches for the rungs this lesson uses (koan:reconcile, koan:author):
    //
