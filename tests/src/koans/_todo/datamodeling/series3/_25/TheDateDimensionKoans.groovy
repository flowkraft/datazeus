package datazeus.datamodeling.series3._25
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 25 The Date Dimension
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _25     (Windows)
 *     ./zeus.sh koans datamodeling series3 _25    (macOS/Linux)
 *
...
class TheDateDimensionKoans extends SchemaKoanBase {
