package datazeus.datamodeling.series3._10
...
/**
 * ╔════════════════════════════════════════════════════════════════════════╗
 * ║  SCHEMA KOANS — Data Modeling · Series 3 · 10 Snowflake vs Star
 * ╚════════════════════════════════════════════════════════════════════════╝
 *
 * BOILERPLATE — no koans written yet. The brief is below; delete it as you write them.
 *
 *     zeus.bat koans datamodeling series3 _10     (Windows)
 *     ./zeus.sh koans datamodeling series3 _10    (macOS/Linux)
 *
...
class SnowflakeVsStarKoans extends SchemaKoanBase {
