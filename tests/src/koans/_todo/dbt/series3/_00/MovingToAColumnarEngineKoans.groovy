package datazeus.dbt.series3._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Moving to a Columnar Engine — The Same dbt Project, Pointed at ClickHouse
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_00/ when it is real.
 *
 *     zeus.bat koans dbt series3 _00     (Windows)
 *     ./zeus.sh koans dbt series3 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class MovingToAColumnarEngineKoans extends KoanBase {
