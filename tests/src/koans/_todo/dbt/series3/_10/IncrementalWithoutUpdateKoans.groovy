package datazeus.dbt.series3._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Incremental Without UPDATE — Replacing a Partition Instead of Editing Rows
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_10/ when it is real.
 *
 *     zeus.bat koans dbt series3 _10     (Windows)
 *     ./zeus.sh koans dbt series3 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   ClickHouse, via dbt-clickhouse. Series 3 · 00 is the move; everything after it runs there.
 *
 * ── THE RULES ───────────────────────────────────────────────────────────
 ...
 *   RERUN — run it twice and assert the SECOND run changed nothing. This is the
 *     whole point: a single run cannot tell a correct load from a duplicating one.
 *   CHOOSE — two defensible options, one right for THIS case. The blank is the
 *     decision, and the koan must make the wrong choice visibly cost something.
 *
 ...
 */
@Stepwise
class IncrementalWithoutUpdateKoans extends KoanBase {
