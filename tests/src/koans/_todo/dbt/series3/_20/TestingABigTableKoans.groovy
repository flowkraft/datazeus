package datazeus.dbt.series3._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Testing a Big Table — Why unique Stops Being Free, and What to Assert Instead
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_20/ when it is real.
 *
 *     zeus.bat koans dbt series3 _20     (Windows)
 *     ./zeus.sh koans dbt series3 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class TestingABigTableKoans extends KoanBase {
