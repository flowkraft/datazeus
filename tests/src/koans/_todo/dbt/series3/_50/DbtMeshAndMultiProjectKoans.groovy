package datazeus.dbt.series3._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * dbt Mesh & Multi-Project — When One Repo Stops Scaling
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_50/ when it is real.
 *
 *     zeus.bat koans dbt series3 _50     (Windows)
 *     ./zeus.sh koans dbt series3 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DbtMeshAndMultiProjectKoans extends KoanBase {
