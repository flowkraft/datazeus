package datazeus.dbt.series3._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Packages — Reuse Community Code (dbt_utils, codegen)
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_25/ when it is real.
 *
 *     zeus.bat koans dbt series3 _25     (Windows)
 *     ./zeus.sh koans dbt series3 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class PackagesKoans extends KoanBase {
