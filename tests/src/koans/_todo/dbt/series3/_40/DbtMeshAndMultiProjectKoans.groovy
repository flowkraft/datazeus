package datazeus.dbt.series3._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering (dbt) · Series 3 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_40/ when it is real.
 *
 *     zeus.bat koans dbt series3 _40     (Windows)
 *     ./zeus.sh koans dbt series3 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
