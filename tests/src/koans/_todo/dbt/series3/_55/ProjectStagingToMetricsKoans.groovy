package datazeus.dbt.series3._55
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 55
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — A Production Northwind Project: Staging → Marts → Metrics
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_55/ when it is real.
 *
 *     zeus.bat koans dbt series3 _55     (Windows)
 *     ./zeus.sh koans dbt series3 _55    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectStagingToMetricsKoans extends KoanBase {
