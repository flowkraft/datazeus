...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering (dbt) · Series 3 · 30
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * dbt on Columnar Engines — What Runs Unchanged, and What You Have to Rewrite
 *
 ...
 */
@Stepwise
class DbtOnColumnarEnginesKoans extends KoanBase {
