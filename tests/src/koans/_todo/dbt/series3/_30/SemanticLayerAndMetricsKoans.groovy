package datazeus.dbt.series3._30
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 30
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * The Semantic Layer & Metrics — One Definition of Revenue, in Code
 *
 ...
 * src/koans/groovy/datazeus/dbt/series3/_30/ when it is real.
 *
 *     zeus.bat koans dbt series3 _30     (Windows)
 *     ./zeus.sh koans dbt series3 _30    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SemanticLayerAndMetricsKoans extends KoanBase {
