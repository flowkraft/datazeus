...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 3 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Materializations on ClickHouse — MergeTree Tables and the View That Is Not Free
 *
 ...
 */
@Stepwise
class ClickhouseMaterializationsKoans extends KoanBase {
