package datazeus.dbt.series2._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Snapshots — SCD Type 2 History Without Writing the Merge
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_20/ when it is real.
 *
 *     zeus.bat koans dbt series2 _20     (Windows)
 *     ./zeus.sh koans dbt series2 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SnapshotsKoans extends KoanBase {
