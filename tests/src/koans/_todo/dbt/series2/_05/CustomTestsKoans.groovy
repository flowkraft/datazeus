package datazeus.dbt.series2._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Singular & Custom Tests — Assert the Business Rule, Not Just the Column
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_05/ when it is real.
 *
 *     zeus.bat koans dbt series2 _05     (Windows)
 *     ./zeus.sh koans dbt series2 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CustomTestsKoans extends KoanBase {
