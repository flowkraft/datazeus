package datazeus.dbt.series2._42
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 42
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Refactoring a Query Pile — One 200-Line SELECT Into a Layered Model Set
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_42/ when it is real.
 *
 *     zeus.bat koans dbt series2 _42     (Windows)
 *     ./zeus.sh koans dbt series2 _42    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class RefactoringAQueryPileKoans extends KoanBase {
