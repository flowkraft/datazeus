package datazeus.dbt.series2._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — A Model Set Whose Tests Catch a Bad Load
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_50/ when it is real.
 *
 *     zeus.bat koans dbt series2 _50     (Windows)
 *     ./zeus.sh koans dbt series2 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectTestsThatCatchItKoans extends KoanBase {
