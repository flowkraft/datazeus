package datazeus.dbt.series2._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Sources & Freshness — Declare Raw Tables and Catch a Stale Feed
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_10/ when it is real.
 *
 *     zeus.bat koans dbt series2 _10     (Windows)
 *     ./zeus.sh koans dbt series2 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SourcesAndFreshnessKoans extends KoanBase {
