package datazeus.dbt.series2._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering (dbt) · Series 2 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Incremental Models — Build Only the New Orders
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_15/ when it is real.
 *
 *     zeus.bat koans dbt series2 _15     (Windows)
 *     ./zeus.sh koans dbt series2 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class IncrementalModelsKoans extends KoanBase {
