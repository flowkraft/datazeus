package datazeus.dbt.series2._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project Structure — staging / intermediate / marts, and Why the Split Holds
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_40/ when it is real.
 *
 *     zeus.bat koans dbt series2 _40     (Windows)
 *     ./zeus.sh koans dbt series2 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectStructureKoans extends KoanBase {
