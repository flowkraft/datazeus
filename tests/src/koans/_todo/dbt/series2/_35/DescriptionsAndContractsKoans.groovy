package datazeus.dbt.series2._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Descriptions & Contracts — Documentation People Actually Trust
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_35/ when it is real.
 *
 *     zeus.bat koans dbt series2 _35     (Windows)
 *     ./zeus.sh koans dbt series2 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DescriptionsAndContractsKoans extends KoanBase {
