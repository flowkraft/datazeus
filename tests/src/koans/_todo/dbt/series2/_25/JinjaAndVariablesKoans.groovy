package datazeus.dbt.series2._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 2 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Jinja & Variables — DRY SQL That's Still Readable
 *
 ...
 * src/koans/groovy/datazeus/dbt/series2/_25/ when it is real.
 *
 *     zeus.bat koans dbt series2 _25     (Windows)
 *     ./zeus.sh koans dbt series2 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class JinjaAndVariablesKoans extends KoanBase {
