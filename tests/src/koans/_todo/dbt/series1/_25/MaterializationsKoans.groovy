package datazeus.dbt.series1._25
 ...
 * src/koans/groovy/datazeus/dbt/series1/_25/ when it is real.
 *
 *     zeus.bat koans dbt series1 _25     (Windows)
 *     ./zeus.sh koans dbt series1 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class MaterializationsKoans extends KoanBase {
