package datazeus.dbt.series1._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Marts — Build dim_customer and fct_sales on Top of Staging
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_35/ when it is real.
 *
 *     zeus.bat koans dbt series1 _35     (Windows)
 *     ./zeus.sh koans dbt series1 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class MartsKoans extends KoanBase {
