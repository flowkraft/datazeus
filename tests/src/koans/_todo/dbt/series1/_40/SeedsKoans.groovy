package datazeus.dbt.series1._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Seeds — Version-Controlled CSV Reference Data
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_40/ when it is real.
 *
 *     zeus.bat koans dbt series1 _40     (Windows)
 *     ./zeus.sh koans dbt series1 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SeedsKoans extends KoanBase {
