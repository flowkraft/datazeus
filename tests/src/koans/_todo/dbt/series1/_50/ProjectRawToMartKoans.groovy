package datazeus.dbt.series1._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — Raw Northwind to a Mart You Can Query
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_50/ when it is real.
 *
 *     zeus.bat koans dbt series1 _50     (Windows)
 *     ./zeus.sh koans dbt series1 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectRawToMartKoans extends KoanBase {
