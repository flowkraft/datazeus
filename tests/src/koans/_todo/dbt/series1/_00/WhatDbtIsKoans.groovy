package datazeus.dbt.series1._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * What dbt Is and Is Not — The T in ELT, as a Real Project
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_00/ when it is real.
 *
 *     zeus.bat koans dbt series1 _00     (Windows)
 *     ./zeus.sh koans dbt series1 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class WhatDbtIsKoans extends KoanBase {
