package datazeus.dbt.series1._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * ref() & source() — How dbt Works Out What to Build First
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_20/ when it is real.
 *
 *     zeus.bat koans dbt series1 _20     (Windows)
 *     ./zeus.sh koans dbt series1 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class RefAndSourceKoans extends KoanBase {
