package datazeus.dbt.series1._05
 ...
 * src/koans/groovy/datazeus/dbt/series1/_05/ when it is real.
 *
 *     zeus.bat koans dbt series1 _05     (Windows)
 *     ./zeus.sh koans dbt series1 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class YourFirstModelKoans extends KoanBase {
