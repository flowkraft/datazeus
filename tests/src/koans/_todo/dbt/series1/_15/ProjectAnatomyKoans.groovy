package datazeus.dbt.series1._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project Anatomy — profiles.yml, dbt_project.yml and the models Folder
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_15/ when it is real.
 *
 *     zeus.bat koans dbt series1 _15     (Windows)
 *     ./zeus.sh koans dbt series1 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectAnatomyKoans extends KoanBase {
