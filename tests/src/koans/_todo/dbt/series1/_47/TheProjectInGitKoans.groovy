package datazeus.dbt.series1._47
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Analytics Engineering with dbt · Series 1 · 47
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * The Project in Git — What Belongs in the Repo, and What Must Never
 *
 ...
 * src/koans/groovy/datazeus/dbt/series1/_47/ when it is real.
 *
 *     zeus.bat koans dbt series1 _47     (Windows)
 *     ./zeus.sh koans dbt series1 _47    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class TheProjectInGitKoans extends KoanBase {
