package datazeus.dataops.series1._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 1 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * The Terminal — Why One Pipe Answers a Data Question Faster Than a GUI
 *
 ...
 * src/koans/groovy/datazeus/dataops/series1/_00/ when it is real.
 *
 *     zeus.bat koans dataops series1 _00     (Windows)
 *     ./zeus.sh koans dataops series1 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class WhyTheTerminalKoans extends KoanBase {
