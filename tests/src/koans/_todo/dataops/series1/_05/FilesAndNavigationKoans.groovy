package datazeus.dataops.series1._05
 ...
 * src/koans/groovy/datazeus/dataops/series1/_05/ when it is real.
 *
 *     zeus.bat koans dataops series1 _05     (Windows)
 *     ./zeus.sh koans dataops series1 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class FilesAndNavigationKoans extends KoanBase {
