package datazeus.dataops.series1._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 1 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * cron & systemd Timers — Turn a Script into a Nightly Job
 *
 ...
 * src/koans/groovy/datazeus/dataops/series1/_40/ when it is real.
 *
 *     zeus.bat koans dataops series1 _40     (Windows)
 *     ./zeus.sh koans dataops series1 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CronAndSystemdTimersKoans extends KoanBase {
