package datazeus.dataops.series1._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 1 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * cat, less, head, tail & wc — Look at Data Without a Database
 *
 ...
 * src/koans/groovy/datazeus/dataops/series1/_10/ when it is real.
 *
 *     zeus.bat koans dataops series1 _10     (Windows)
 *     ./zeus.sh koans dataops series1 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class LookAtDataWithoutADatabaseKoans extends KoanBase {
