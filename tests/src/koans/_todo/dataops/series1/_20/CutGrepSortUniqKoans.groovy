package datazeus.dataops.series1._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 1 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * cut, grep, sort & uniq — Slice Columns and Rows on the Command Line
 *
 ...
 * src/koans/groovy/datazeus/dataops/series1/_20/ when it is real.
 *
 *     zeus.bat koans dataops series1 _20     (Windows)
 *     ./zeus.sh koans dataops series1 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CutGrepSortUniqKoans extends KoanBase {
