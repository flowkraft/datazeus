package datazeus.dataops.series1._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 1 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — A Nightly Job Written Only With Shell Tools
 *
 ...
 * src/koans/groovy/datazeus/dataops/series1/_50/ when it is real.
 *
 *     zeus.bat koans dataops series1 _50     (Windows)
 *     ./zeus.sh koans dataops series1 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectNightlyJobInShellKoans extends KoanBase {
