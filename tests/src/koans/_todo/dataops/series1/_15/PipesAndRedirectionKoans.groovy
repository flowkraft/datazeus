package datazeus.dataops.series1._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 1 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Pipes & Redirection — Compose Tiny Tools into a Pipeline
 *
 ...
 * src/koans/groovy/datazeus/dataops/series1/_15/ when it is real.
 *
 *     zeus.bat koans dataops series1 _15     (Windows)
 *     ./zeus.sh koans dataops series1 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class PipesAndRedirectionKoans extends KoanBase {
