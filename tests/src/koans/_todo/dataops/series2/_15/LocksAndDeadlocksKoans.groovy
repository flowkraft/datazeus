package datazeus.dataops.series2._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 2 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Locks & Deadlocks — Why Your UPDATE Is Hanging
 *
 ...
 * src/koans/groovy/datazeus/dataops/series2/_15/ when it is real.
 *
 *     zeus.bat koans dataops series2 _15     (Windows)
 *     ./zeus.sh koans dataops series2 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class LocksAndDeadlocksKoans extends KoanBase {
