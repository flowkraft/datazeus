package datazeus.dataops.series2._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 2 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Connections & Pooling — PgBouncer and the Limit You Will Hit
 *
 ...
 * src/koans/groovy/datazeus/dataops/series2/_20/ when it is real.
 *
 *     zeus.bat koans dataops series2 _20     (Windows)
 *     ./zeus.sh koans dataops series2 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   COUNT:QUERIES — assert how many times you went to the database. Both versions
 *     give the right answer; the count is the lesson.
 ...
 */
@Stepwise
class ConnectionsAndPoolingKoans extends KoanBase {
