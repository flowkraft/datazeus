package datazeus.dataops.series2._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 2 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Isolation Levels: The ANSI Four — Dirty Reads, Phantoms & What Postgres Really Does
 *
 ...
 * src/koans/groovy/datazeus/dataops/series2/_05/ when it is real.
 *
 *     zeus.bat koans dataops series2 _05     (Windows)
 *     ./zeus.sh koans dataops series2 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class IsolationLevelsKoans extends KoanBase {
