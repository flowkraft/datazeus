package datazeus.dataops.series2._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 2 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Schema Migrations Without Downtime — Locks, Defaults & the Safe Order
 *
 ...
 * src/koans/groovy/datazeus/dataops/series2/_35/ when it is real.
 *
 *     zeus.bat koans dataops series2 _35     (Windows)
 *     ./zeus.sh koans dataops series2 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ZeroDowntimeMigrationsKoans extends KoanBase {
