package datazeus.dataops.series2._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 2 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Configuration & Memory — shared_buffers, work_mem and Defaults Worth Changing
 *
 ...
 * src/koans/groovy/datazeus/dataops/series2/_25/ when it is real.
 *
 *     zeus.bat koans dataops series2 _25     (Windows)
 *     ./zeus.sh koans dataops series2 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ConfigurationAndMemoryKoans extends KoanBase {
