package datazeus.dataops.series2._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 2 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Roles, Grants & Row-Level Security — Least Privilege for Data Access
 *
 ...
 * src/koans/groovy/datazeus/dataops/series2/_40/ when it is real.
 *
 *     zeus.bat koans dataops series2 _40     (Windows)
 *     ./zeus.sh koans dataops series2 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class RolesGrantsAndRlsKoans extends KoanBase {
