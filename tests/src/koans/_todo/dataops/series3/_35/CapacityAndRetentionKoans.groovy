package datazeus.dataops.series3._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Capacity, Storage & Retention — Disk, Partitions and TTL
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_35/ when it is real.
 *
 *     zeus.bat koans dataops series3 _35     (Windows)
 *     ./zeus.sh koans dataops series3 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CapacityAndRetentionKoans extends KoanBase {
