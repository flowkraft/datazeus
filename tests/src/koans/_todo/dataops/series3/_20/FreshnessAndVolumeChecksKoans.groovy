package datazeus.dataops.series3._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Freshness & Volume Checks — Catch a Pipeline That Silently Stopped
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_20/ when it is real.
 *
 *     zeus.bat koans dataops series3 _20     (Windows)
 *     ./zeus.sh koans dataops series3 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class FreshnessAndVolumeChecksKoans extends KoanBase {
