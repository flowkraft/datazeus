package datazeus.dataops.series3._45
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 45
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — Put a Northwind Pipeline On Call
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_45/ when it is real.
 *
 *     zeus.bat koans dataops series3 _45     (Windows)
 *     ./zeus.sh koans dataops series3 _45    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectPipelineOnCallKoans extends KoanBase {
