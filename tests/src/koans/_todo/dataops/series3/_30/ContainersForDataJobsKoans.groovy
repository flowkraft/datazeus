package datazeus.dataops.series3._30
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 30
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Containers for Data Jobs — Compose, Images & Runs You Can Reproduce
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_30/ when it is real.
 *
 *     zeus.bat koans dataops series3 _30     (Windows)
 *     ./zeus.sh koans dataops series3 _30    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   PROCESS:TOOL — run it as a COMMAND and assert the exit code and output.
 ...
 */
@Stepwise
class ContainersForDataJobsKoans extends KoanBase {
