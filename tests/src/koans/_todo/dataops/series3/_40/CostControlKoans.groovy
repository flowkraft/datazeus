package datazeus.dataops.series3._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Cost Control — Compute, Storage and Where the Money Goes
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_40/ when it is real.
 *
 *     zeus.bat koans dataops series3 _40     (Windows)
 *     ./zeus.sh koans dataops series3 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CostControlKoans extends KoanBase {
