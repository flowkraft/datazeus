package datazeus.dataops.series3._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Logging & Structured Output — Make a Failure Readable at 3 a.m.
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_05/ when it is real.
 *
 *     zeus.bat koans dataops series3 _05     (Windows)
 *     ./zeus.sh koans dataops series3 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class LoggingAndStructuredOutputKoans extends KoanBase {
