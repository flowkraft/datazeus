package datazeus.dataops.series3._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Incident Response & Postmortems — Diagnose, Fix, Write It Down
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_25/ when it is real.
 *
 *     zeus.bat koans dataops series3 _25     (Windows)
 *     ./zeus.sh koans dataops series3 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class IncidentResponseKoans extends KoanBase {
