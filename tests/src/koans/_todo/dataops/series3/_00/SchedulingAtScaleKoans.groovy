package datazeus.dataops.series3._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — Data Ops · Series 3 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Scheduling at Scale — Choosing Between cron, systemd Timers and an Orchestrator
 *
 ...
 * src/koans/groovy/datazeus/dataops/series3/_00/ when it is real.
 *
 *     zeus.bat koans dataops series3 _00     (Windows)
 *     ./zeus.sh koans dataops series3 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SchedulingAtScaleKoans extends KoanBase {
