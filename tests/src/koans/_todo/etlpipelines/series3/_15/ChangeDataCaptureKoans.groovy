package datazeus.etlpipelines.series3._15
 ...
 * src/koans/groovy/datazeus/etlpipelines/series3/_15/ when it is real.
 *
 *     zeus.bat koans etlpipelines series3 _15     (Windows)
 *     ./zeus.sh koans etlpipelines series3 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ChangeDataCaptureKoans extends KoanBase {
