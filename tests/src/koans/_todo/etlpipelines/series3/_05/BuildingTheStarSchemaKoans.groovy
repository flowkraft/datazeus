package datazeus.etlpipelines.series3._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 3 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Building the Star Schema — Loading One From SQLite Into DuckDB and ClickHouse
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series3/_05/ when it is real.
 *
 *     zeus.bat koans etlpipelines series3 _05     (Windows)
 *     ./zeus.sh koans etlpipelines series3 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class BuildingTheStarSchemaKoans extends KoanBase {
