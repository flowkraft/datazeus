package datazeus.etlpipelines.series3._45
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 3 · 45
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — Orchestrate the Full Northwind Pipeline End to End
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series3/_45/ when it is real.
 *
 *     zeus.bat koans etlpipelines series3 _45     (Windows)
 *     ./zeus.sh koans etlpipelines series3 _45    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 *   SURFACE `rundeck` — the scheduler DataPallas ships
 *
 ...
 */
@Stepwise
class ProjectOrchestrateNorthwindKoans extends KoanBase {
