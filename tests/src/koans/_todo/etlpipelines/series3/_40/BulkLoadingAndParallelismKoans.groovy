package datazeus.etlpipelines.series3._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 3 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Bulk Loading & Parallelism — COPY, Partitions and Throughput
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series3/_40/ when it is real.
 *
 *     zeus.bat koans etlpipelines series3 _40     (Windows)
 *     ./zeus.sh koans etlpipelines series3 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class BulkLoadingAndParallelismKoans extends KoanBase {
