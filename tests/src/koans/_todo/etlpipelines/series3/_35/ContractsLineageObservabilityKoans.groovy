package datazeus.etlpipelines.series3._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 3 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Data Contracts, Lineage & Observability — Know What Broke, and Who Depends On It
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series3/_35/ when it is real.
 *
 *     zeus.bat koans etlpipelines series3 _35     (Windows)
 *     ./zeus.sh koans etlpipelines series3 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ContractsLineageObservabilityKoans extends KoanBase {
