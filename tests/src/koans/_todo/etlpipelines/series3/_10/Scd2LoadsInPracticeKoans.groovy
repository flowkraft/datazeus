package datazeus.etlpipelines.series3._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 3 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * SCD Type 2 Loads — Keep History Without Duplicating It
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series3/_10/ when it is real.
 *
 *     zeus.bat koans etlpipelines series3 _10     (Windows)
 *     ./zeus.sh koans etlpipelines series3 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class Scd2LoadsInPracticeKoans extends KoanBase {
