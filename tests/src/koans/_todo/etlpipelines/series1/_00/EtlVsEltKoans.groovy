package datazeus.etlpipelines.series1._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * What a Pipeline Is — Extract, Transform, Load, and Where Each One Happens
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_00/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _00     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class EtlVsEltKoans extends KoanBase {
