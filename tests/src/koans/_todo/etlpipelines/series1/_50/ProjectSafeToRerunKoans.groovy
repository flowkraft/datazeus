package datazeus.etlpipelines.series1._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — A Load That Is Safe to Run Twice
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_50/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _50     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectSafeToRerunKoans extends KoanBase {
