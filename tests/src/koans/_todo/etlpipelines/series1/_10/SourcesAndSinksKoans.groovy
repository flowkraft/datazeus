package datazeus.etlpipelines.series1._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Sources & Sinks — Files, APIs and Databases as Connections
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_10/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _10     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class SourcesAndSinksKoans extends KoanBase {
