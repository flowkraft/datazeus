package datazeus.etlpipelines.series1._20
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 20
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Types & Casting Across Sources — When 'Y', 'yes' and 1 All Mean True
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_20/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _20     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _20    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class TypesAndCastingAcrossSourcesKoans extends KoanBase {
