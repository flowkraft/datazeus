package datazeus.etlpipelines.series1._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Row Counts & Logging — Proving the Load Did What You Think
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_40/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _40     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class RowCountsAndLoggingKoans extends KoanBase {
