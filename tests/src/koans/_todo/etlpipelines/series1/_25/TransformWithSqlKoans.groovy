package datazeus.etlpipelines.series1._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Transform with SQL — Reshaping the Data on Its Way In
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_25/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _25     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class TransformWithSqlKoans extends KoanBase {
