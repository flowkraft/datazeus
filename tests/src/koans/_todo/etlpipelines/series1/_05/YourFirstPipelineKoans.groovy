package datazeus.etlpipelines.series1._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Your First Pipeline — Load a CSV into a Table
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_05/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _05     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class YourFirstPipelineKoans extends KoanBase {
