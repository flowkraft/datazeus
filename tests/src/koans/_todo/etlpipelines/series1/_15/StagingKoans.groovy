package datazeus.etlpipelines.series1._15
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 1 · 15
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Staging — Land Raw Before You Transform Anything
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series1/_15/ when it is real.
 *
 *     zeus.bat koans etlpipelines series1 _15     (Windows)
 *     ./zeus.sh koans etlpipelines series1 _15    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class StagingKoans extends KoanBase {
