package datazeus.etlpipelines.series2._00
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 00
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Scripting a Pipeline — When a Script Beats a Chain of SQL Files
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_00/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _00     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _00    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ScriptedPipelinesKoans extends KoanBase {
