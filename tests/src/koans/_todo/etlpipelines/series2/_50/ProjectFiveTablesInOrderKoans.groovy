package datazeus.etlpipelines.series2._50
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 50
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Project — One Job That Loads Five Tables in the Right Order
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_50/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _50     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _50    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ProjectFiveTablesInOrderKoans extends KoanBase {
