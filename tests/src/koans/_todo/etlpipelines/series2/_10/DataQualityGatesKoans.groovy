package datazeus.etlpipelines.series2._10
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 10
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Data Quality Gates — Nulls, Ranges and Referential Gaps, Before They Land
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_10/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _10     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _10    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class DataQualityGatesKoans extends KoanBase {
