package datazeus.etlpipelines.series2._40
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 40
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Cross-Database Pipelines — Northwind PostgreSQL → ClickHouse
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_40/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _40     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _40    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class CrossDatabasePipelinesKoans extends KoanBase {
