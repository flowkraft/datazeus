package datazeus.etlpipelines.series2._05
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 05
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Parameterized & Reusable Jobs — One Script, Many Tables
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_05/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _05     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _05    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ParameterizedAndReusableJobsKoans extends KoanBase {
