package datazeus.etlpipelines.series2._35
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 35
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Load Order — Dimensions First, Then Facts, and What Breaks Otherwise
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_35/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _35     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _35    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class LoadOrderKoans extends KoanBase {
