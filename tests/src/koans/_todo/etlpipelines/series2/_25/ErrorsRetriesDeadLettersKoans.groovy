package datazeus.etlpipelines.series2._25
...
/**
 * ╔══════════════════════════════════════════════════════════════════════════╗
 * ║  KOANS — ETL & Data Pipelines · Series 2 · 25
 * ╚══════════════════════════════════════════════════════════════════════════╝
 *
 * Errors, Retries & Dead Letters — Fail Without Losing Rows
 *
 ...
 * src/koans/groovy/datazeus/etlpipelines/series2/_25/ when it is real.
 *
 *     zeus.bat koans etlpipelines series2 _25     (Windows)
 *     ./zeus.sh koans etlpipelines series2 _25    (macOS/Linux)
 *
 * ── READ THESE FIRST ────────────────────────────────────────────────────
 ...
 */
@Stepwise
class ErrorsRetriesDeadLettersKoans extends KoanBase {
