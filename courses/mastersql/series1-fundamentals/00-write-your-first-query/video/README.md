...
```
flowkraft/www/cli-remotion/src/videos/rb/mastersql-series1-00-write-your-first-query/index.tsx
```

It's registered in `cli-remotion/src/remotion-root.tsx` (composition
`mastersql-series1-00-write-your-first-query`) and in `VIDEO_REPOSITORY` in
...
lesson via `<VideoPlayer videoId="mastersql-series1-00-write-your-first-query" />`.
